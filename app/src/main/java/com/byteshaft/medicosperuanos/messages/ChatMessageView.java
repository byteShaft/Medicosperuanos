...
import com.byteshaft.medicosperuanos.utils.ViewUtil;
...
public class ChatMessageView extends RelativeLayout {
    ...
    private void initialize(AttributeSet attrs, int defStyleAttr) {
        TypedArray a = getContext().obtainStyledAttributes(attrs, com.byteshaft.medicosperuanos.R.styleable.ChatMessageView, defStyleAttr, 0);

        showArrow = a.getBoolean(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_showArrow, true);
        arrowMargin = a.getDimension(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_arrowMargin, dip2px(5));
        cornerRadius = a.getDimension(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_cornerRadius, 0);
        contentPadding = a.getDimension(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_contentPadding, dip2px(10));
        backgroundColor = a.getColor(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_backgroundColor, 0);
        backgroundColorPressed = a.getColor(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_backgroundColorPressed, 0);

        int intPosition = a.getInt(com.byteshaft.medicosperuanos.R.styleable.ChatMessageView_cmv_arrowPosition, ArrowPosition.LEFT.getValue());
