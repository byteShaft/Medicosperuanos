 ...
 */
package com.byteshaft.medicosperuanos.utils.Actions;
...
import com.byteshaft.medicosperuanos.utils.Helper.EmojiconEditText;
import com.byteshaft.medicosperuanos.utils.Helper.EmojiconGridView;
import com.byteshaft.medicosperuanos.utils.Helper.EmojiconsPopup;
...
public class EmojIconActions implements View.OnFocusChangeListener {
    ...
    private int KeyBoardIcon = com.byteshaft.medicosperuanos.R.drawable.ic_action_keyboard;
    private int SmileyIcons = com.byteshaft.medicosperuanos.R.drawable.smiley;
