...
import com.byteshaft.medicosperuanos.utils.emoji.Cars;
import com.byteshaft.medicosperuanos.utils.emoji.Electr;
import com.byteshaft.medicosperuanos.utils.emoji.Emojicon;
import com.byteshaft.medicosperuanos.utils.emoji.Food;
import com.byteshaft.medicosperuanos.utils.emoji.Nature;
import com.byteshaft.medicosperuanos.utils.emoji.People;
import com.byteshaft.medicosperuanos.utils.emoji.Sport;
import com.byteshaft.medicosperuanos.utils.emoji.Symbols;
